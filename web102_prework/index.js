...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        div.innerHTML = `${game.name}: ${game.description} <br> <br> <img src=${game.img} class=game-img>
        `
...
const description = `A total of ${totalRaised.toLocaleString('en-US')} has been raised for ${numGames>0 ? numGames+" games" : 0}.
We need your help to fund the last ${unfunded.length} games!`;
